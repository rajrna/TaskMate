<?php
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $add_task = "INSERT INTO todays_tasks (task_id,task_name,task_description,due_date,priority,user_id)VALUES ('$task_id','$task_name','$task_description','$due_date','$priority','{$_SESSION['user_id']}')";
